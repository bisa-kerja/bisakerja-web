...
export default function Home() {
  return (
    <div className="flex min-h-screen flex-col bg-white text-gray-950" style={{ colorScheme: "light" }}>
      <Navbar />
      ...
      <main className="flex-1">
        <section className="overflow-hidden bg-white">
          <ContainerScroll
            titleComponent={
              <div className="mx-auto max-w-4xl px-6 pt-10 md:px-8">
               ...
               Let AI Find the Jobs That Best Match Your CV.
                </h1>
                <p className="mx-auto mt-5 max-w-2xl text-base leading-7 text-gray-600 sm:text-lg">
                  BisaKerja helps you find relevant vacancies, understand your CV quality, and make application decisions more confidently.
                </p>
          ...
          <div className="mx-auto grid max-w-[1240px] grid-cols-1 gap-10 lg:grid-cols-[0.9fr_1.1fr] lg:items-center">
            <div>
              <h2 className="mt-2 text-3xl font-bold text-gray-950 sm:text-4xl">Built for a more focused application process.</h2>
              <p className="mt-4 text-base leading-7 text-gray-600">
                From exploring vacancies to evaluating your CV, every step is designed so you know what to do next.
              </p>
            </div>
          ...
          <div className="mx-auto max-w-[1240px]">
            <div className="flex flex-col justify-between gap-4 md:flex-row md:items-end">
              <div className="max-w-2xl">
                <h2 className="mt-2 text-3xl font-bold text-gray-950 sm:text-4xl">User stories: Feeling more prepared when choosing opportunities.</h2>
              </div>
            </div>
